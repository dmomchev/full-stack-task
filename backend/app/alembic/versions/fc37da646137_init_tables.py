...
Revision ID: fc37da646137
Revises: 
Create Date: 2025-11-25 12:51:04.272226
...
def upgrade() -> None:
    ...
    sa.Column('car_spec_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['car_spec_id'], ['car_specs.id'], ondelete='CASCADE'),
